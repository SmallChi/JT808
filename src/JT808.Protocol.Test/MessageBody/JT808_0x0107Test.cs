...
namespace JT808.Protocol.Test.MessageBodyReply
{
    public class JT808_0x0107Test
    {
        ...
        public void Test1()
        {
            ...
            {
                MsgId = Enums.JT808MsgId.查询终端属性应答,
                MsgNum = 8888,
                TerminalPhoneNo = "112233445566",
            };
            JT808_0x0107 jT808_0X0107 = new JT808_0x0107();
            // 00000000 00000101
            jT808_0X0107.TerminalType = 5;
            jT808_0X0107.MakerId = "10601";
            jT808_0X0107.TerminalModel = "10455545955103";
            jT808_0X0107.TerminalId = "4d6a13";
            jT808_0X0107.Terminal_SIM_ICCID = "1232355987";
            jT808_0X0107.Terminal_Hardware_Version_Num = "abcdefg";
            jT808_0X0107.Terminal_Firmware_Version_Num = "poiuytrewq";
            // 00000111
            jT808_0X0107.GNSSModule = 7;
            // 00001001
            jT808_0X0107.CommunicationModule = 9;
        ...
        public void Test2()
        {
            ...
            Assert.Equal(Enums.JT808MsgId.查询终端属性应答, jT808Package.Header.MsgId);
