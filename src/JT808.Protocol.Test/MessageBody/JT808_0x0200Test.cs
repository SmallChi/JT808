...
namespace JT808.Protocol.Test.MessageBody
{
    public class JT808_0x0200Test
    {
        ...
        [Fact]
        public void Test_attcahid_0x2b()
        {
            var bytes = "7E0200005D013043210062001F00000000000C00020158A3CA06CA1D17000000000000251208164148010400000000300180310109020200002B0812A803DC0001000051080050005000D200006102055F580800000000001700006102055FE00412A80000E8030000001A7E".ToHexBytes();
            var package = JT808Serializer1.Analyze(bytes);
        }
        ...
        public void LatLngTest1_1()
        {
            ...
            jT808UploadLocationRequest.StatusFlag = 0b1100;
            var hex = JT808Serializer.Serialize(jT808UploadLocationRequest).ToHexString();
            Assert.Equal("000000010000000CFF4580F2F81B0EE40028003C0000180715101010", hex);
        }
        [Fact]
        ...
        public void LatTest1_1()
        {
            ...
            jT808UploadLocationRequest.StatusFlag = 0b100;
            var hex = JT808Serializer.Serialize(jT808UploadLocationRequest).ToHexString();
            Assert.Equal("0000000100000004FF4580F207E4F11C0028003C0000180715101010", hex);
        }
        [Fact]
        ...
        public void LatTest2()
        {
            JT808Exception exception= Assert.Throws<JT808Exception>(() => {
                ...
                jT808UploadLocationRequest.StatusFlag = 0b10000;
                var hex = JT808Serializer.Serialize(jT808UploadLocationRequest).ToHexString();
            });
        ...
        public void LatTest3_1()
        {
            ...
            jT808UploadLocationRequest.StatusFlag = 0b0100;
            var hex = JT808Serializer.Serialize(jT808UploadLocationRequest).ToHexString();
            Assert.Equal("0000000100000004FF4580F207E4F11C0028003C0000180715101010", hex);
        }
        [Fact]
        ...
        [Fact]
        public void AltitudeTest1()
        {
            byte[] hex = "".ToHexBytes();
            var  package = JT808Serializer.Deserialize(hex);
            JT808_0x0200 body = package.Bodies as JT808_0x0200;
            Assert.Equal(-8, body.Altitude);
        }

        [Fact]
        public void AltitudeTestJson1()
        {
            byte[] hex = "".ToHexBytes();
            var json = JT808Serializer.Analyze(hex);
        }
    }
}
