...
namespace JT808.Protocol.JT808PackageImpl.Reply
{
    ...
    {
        public JT808_0x8100Package(JT808Header jT808Header, JT808_0x8100 bodies) : base(jT808Header,  bodies)
        {
        }

        protected override JT808Package Create(JT808Header jT808Header,  JT808_0x8100 bodies)
        {
