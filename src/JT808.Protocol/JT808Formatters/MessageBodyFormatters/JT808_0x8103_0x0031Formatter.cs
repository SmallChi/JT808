...
{
    public class JT808_0x8103_0x0031Formatter : IJT808Formatter<JT808_0x8103_0x0031>
    {
        public JT808_0x8103_0x0031 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0031.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0031.ParamValue = JT808BinaryExtensions.ReadUInt16Little(bytes, ref offset);
            readSize = offset;
