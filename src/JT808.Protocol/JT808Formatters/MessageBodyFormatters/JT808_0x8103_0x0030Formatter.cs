...
{
    public class JT808_0x8103_0x0030Formatter : IJT808Formatter<JT808_0x8103_0x0030>
    {
        public JT808_0x8103_0x0030 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0030.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0030.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
