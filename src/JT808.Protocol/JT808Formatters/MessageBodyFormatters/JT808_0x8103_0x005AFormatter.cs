...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x005AFormatter : IJT808Formatter<JT808_0x8103_0x005A>
    {
        public JT808_0x8103_0x005A Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x005A.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x005A.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
