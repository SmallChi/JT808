...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x005BFormatter : IJT808Formatter<JT808_0x8103_0x005B>
    {
        public JT808_0x8103_0x005B Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x005B.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x005B.ParamValue = JT808BinaryExtensions.ReadUInt16Little(bytes, ref offset);
            readSize = offset;
