...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x0081Formatter : IJT808Formatter<JT808_0x8103_0x0081>
    {
        public JT808_0x8103_0x0081 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0081.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0081.ParamValue = JT808BinaryExtensions.ReadUInt16Little(bytes, ref offset);
            readSize = offset;
