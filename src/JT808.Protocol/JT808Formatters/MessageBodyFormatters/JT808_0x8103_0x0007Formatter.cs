...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x0007Formatter : IJT808Formatter<JT808_0x8103_0x0007>
    {
        public JT808_0x8103_0x0007 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0007.ParamId = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            jT808_0x8103_0x0007.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0007.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
