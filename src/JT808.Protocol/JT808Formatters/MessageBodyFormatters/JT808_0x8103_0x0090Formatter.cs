...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x0090Formatter : IJT808Formatter<JT808_0x8103_0x0090>
    {
        public JT808_0x8103_0x0090 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0090.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0090.ParamValue = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            readSize = offset;
