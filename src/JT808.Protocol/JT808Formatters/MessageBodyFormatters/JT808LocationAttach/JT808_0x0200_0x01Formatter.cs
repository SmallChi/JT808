...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters.JT808LocationAttach
{
    public class JT808_0x0200_0x01Formatter : IJT808Formatter<JT808LocationAttachImpl0x01>
    {
        ...
        public int Serialize(IMemoryOwner<byte> memoryOwner, int offset, JT808LocationAttachImpl0x01 value)
        {
            ...
            offset += JT808BinaryExtensions.WriteInt32Little(memoryOwner, offset, value.Mileage);
            return offset;
        }
    }
}
