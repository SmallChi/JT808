...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x005DFormatter : IJT808Formatter<JT808_0x8103_0x005D>
    {
        public JT808_0x8103_0x005D Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x005D.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x005D.ParamValue = JT808BinaryExtensions.ReadUInt16Little(bytes, ref offset);
            readSize = offset;
