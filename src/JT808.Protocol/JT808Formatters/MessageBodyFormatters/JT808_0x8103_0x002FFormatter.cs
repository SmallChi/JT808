...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x002FFormatter : IJT808Formatter<JT808_0x8103_0x002F>
    {
        public JT808_0x8103_0x002F Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x002F.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x002F.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
