...
{
    public class JT808_0x8103_0x0006Formatter : IJT808Formatter<JT808_0x8103_0x0006>
    {
        public JT808_0x8103_0x0006 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x0006.ParamId = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            jT808_0x8103_0x0006.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x0006.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
