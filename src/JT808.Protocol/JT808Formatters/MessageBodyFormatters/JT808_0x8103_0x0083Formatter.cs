...
{
    public class JT808_0x8103_0x0083Formatter : IJT808Formatter<JT808_0x8103_0x0083>
    {
        public JT808_0x8103_0x0083 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            int offset = 0;
            JT808_0x8103_0x0083 jT808_0x8103_0x0083 = new JT808_0x8103_0x0083();
            jT808_0x8103_0x0083.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
        ...
        public int Serialize(ref byte[] bytes, int offset, JT808_0x8103_0x0083 value)
        {
            offset += 1;
