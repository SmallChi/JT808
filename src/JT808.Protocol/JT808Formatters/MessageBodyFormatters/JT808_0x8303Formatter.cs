...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8303Formatter : IJT808Formatter<JT808_0x8303>
    {
        public JT808_0x8303 Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0X8303.SettingType = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0X8303.InformationItemCount = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            ...
            for(var i=0;i< jT808_0X8303.InformationItemCount; i++)
            {
                ...
                jT808InformationItemProperty.InformationType= JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
                jT808InformationItemProperty.InformationLength = JT808BinaryExtensions.ReadUInt16Little(bytes, ref offset);
