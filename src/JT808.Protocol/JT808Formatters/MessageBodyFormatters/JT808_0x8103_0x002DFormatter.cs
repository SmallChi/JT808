...
namespace JT808.Protocol.JT808Formatters.MessageBodyFormatters
{
    public class JT808_0x8103_0x002DFormatter : IJT808Formatter<JT808_0x8103_0x002D>
    {
        public JT808_0x8103_0x002D Deserialize(ReadOnlySpan<byte> bytes, out int readSize)
        {
            ...
            jT808_0x8103_0x002D.ParamLength = JT808BinaryExtensions.ReadByteLittle(bytes, ref offset);
            jT808_0x8103_0x002D.ParamValue = JT808BinaryExtensions.ReadUInt32Little(bytes, ref offset);
            readSize = offset;
