...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 超速持续时间，单位为秒（s）
    /// </summary>
    public class JT808_0x8103_0x0056 : JT808MessagePackFormatter<JT808_0x8103_0x0056>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0056
        /// </summary>
        public uint ParamId { get; set; } = 0x0056;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// 超速持续时间
        /// </summary>
        public string Description => "超速持续时间";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0056 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0056 jT808_0x8103_0x0056 = new JT808_0x8103_0x0056();
            jT808_0x8103_0x0056.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0056.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0056 value, IJT808Config config)
        {
