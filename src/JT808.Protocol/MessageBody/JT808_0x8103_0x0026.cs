...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 2019版本
    /// </summary>
    public class JT808_0x8103_0x0026 : JT808MessagePackFormatter<JT808_0x8103_0x0026>, JT808_0x8103_BodyBase,  IJT808_2019_Version, IJT808Analyze
    {
        /// <summary>
        /// 0x0026
        /// </summary>
        public uint ParamId { get; set; } = 0x0026;
        /// <summary>
        /// 数据长度
        /// n byte
        /// </summary>
        ...
        /// 从服务器备份地址IP
        /// </summary>
        public  string Description => "从服务器备份地址IP";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0026 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0026 value = new JT808_0x8103_0x0026();
            value.ParamId = reader.ReadUInt32();
            value.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0026 value, IJT808Config config)
        {
