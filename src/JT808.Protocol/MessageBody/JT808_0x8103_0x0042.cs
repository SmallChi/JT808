...
namespace JT808.Protocol.MessageBody
{
    ...
    /// </summary>
    public class JT808_0x8103_0x0042 : JT808MessagePackFormatter<JT808_0x8103_0x0042>, JT808_0x8103_BodyBase,  IJT808Analyze
    {
        /// <summary>
        /// 0x0042
        /// </summary>
        public  uint ParamId { get; set; } = 0x0042;
        /// <summary>
        /// 数据长度
        /// n byte
        /// </summary>
        ...
        /// 恢复出厂设置电话号码
        /// </summary>
        public  string Description => "恢复出厂设置电话号码";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0042 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0042 jT808_0x8103_0x0042 = new JT808_0x8103_0x0042();
            jT808_0x8103_0x0042.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0042.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0042 value, IJT808Config config)
        {
