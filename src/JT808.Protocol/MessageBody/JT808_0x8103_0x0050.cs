...
namespace JT808.Protocol.MessageBody
{
    ...
    /// </summary>
    public class JT808_0x8103_0x0050 : JT808MessagePackFormatter<JT808_0x8103_0x0050>, JT808_0x8103_BodyBase,  IJT808Analyze
    {
        /// <summary>
        /// 0x0050
        /// </summary>
        public uint ParamId { get; set; } = 0x0050;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// 报警屏蔽字
        /// </summary>
        public string Description => "报警屏蔽字";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0050 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0050 jT808_0x8103_0x0050 = new JT808_0x8103_0x0050();
            jT808_0x8103_0x0050.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0050.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0050 value, IJT808Config config)
        {
