...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 公安交通管理部门颁发的机动车号牌
    /// </summary>
    public class JT808_0x8103_0x0083 : JT808MessagePackFormatter<JT808_0x8103_0x0083>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0083
        /// </summary>
        public uint ParamId { get; set; } = 0x0083;
        /// <summary>
        /// 数据长度
        /// n byte
        /// </summary>
        ...
        /// 公安交通管理部门颁发的机动车号牌
        /// </summary>
        public string Description => "公安交通管理部门颁发的机动车号牌";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0083 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0083 jT808_0x8103_0x0083 = new JT808_0x8103_0x0083();
            jT808_0x8103_0x0083.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0083.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0083 value, IJT808Config config)
        {
