...
namespace JT808.Protocol.MessageBody.CarDVR
{
    ...
    /// 返回：符合条件的驾驶人登录退出记录
    /// </summary>
    public class JT808_CarDVR_Down_0x12 : JT808MessagePackFormatter<JT808_CarDVR_Down_0x12>, JT808CarDVRDownBodies,  IJT808Analyze
    {
        /// <summary>
        /// 0x12
        /// </summary>
        ...
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_CarDVR_Down_0x12 value, IJT808Config config)
        {
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_CarDVR_Down_0x12 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
