...
namespace JT808.Protocol.MessageBody
{
    ...
    /// </summary>
    public class JT808_0x8103_0x0093 : JT808MessagePackFormatter<JT808_0x8103_0x0093>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0093
        /// </summary>
        public  uint ParamId { get; set; } = 0x0093;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// GNSS模块详细定位数据采集频率
        /// </summary>
        public  string Description => "GNSS模块详细定位数据采集频率";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0093 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0093 jT808_0x8103_0x0093 = new JT808_0x8103_0x0093();
            jT808_0x8103_0x0093.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0093.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0093 value, IJT808Config config)
        {
