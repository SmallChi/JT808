...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 主服务器无线通信拨号用户名
    /// </summary>
    public class JT808_0x8103_0x0011 : JT808MessagePackFormatter<JT808_0x8103_0x0011>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0011
        /// </summary>
        public  uint ParamId { get; set; } = 0x0011;
        /// <summary>
        /// 数据长度
        /// n byte
        /// </summary>
        ...
        /// 主服务器无线通信拨号用户名
        /// </summary>
        public  string Description => "主服务器无线通信拨号用户名";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0011 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0011 jT808_0x8103_0x0011 = new JT808_0x8103_0x0011();
            jT808_0x8103_0x0011.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0011.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0011 value, IJT808Config config)
        {
