...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 缺省时间汇报间隔，单位为秒（s），>0
    /// </summary>
    public class JT808_0x8103_0x0029 : JT808MessagePackFormatter<JT808_0x8103_0x0029>, JT808_0x8103_BodyBase,  IJT808Analyze
    {
        /// <summary>
        /// 0x0029
        /// </summary>
        public uint ParamId { get; set; } = 0x0029;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// 缺省时间汇报间隔
        /// </summary>
        public  string Description => "缺省时间汇报间隔";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0029 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0029 jT808_0x8103_0x0029 = new JT808_0x8103_0x0029();
            jT808_0x8103_0x0029.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0029.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0029 value, IJT808Config config)
        {
