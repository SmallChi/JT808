...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 电子围栏半径（非法位移阈值），单位为米
    /// </summary>
    public class JT808_0x8103_0x0031 : JT808MessagePackFormatter<JT808_0x8103_0x0031>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0031
        /// </summary>
        public uint ParamId { get; set; } = 0x0031;
        /// <summary>
        /// 数据长度
        /// 2 byte
        /// </summary>
        ...
        /// 电子围栏半径
        /// </summary>
        public string Description => "电子围栏半径";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0031 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0031 jT808_0x8103_0x0031 = new JT808_0x8103_0x0031();
            jT808_0x8103_0x0031.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0031.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0031 value, IJT808Config config)
        {
