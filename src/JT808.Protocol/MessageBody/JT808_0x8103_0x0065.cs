...
namespace JT808.Protocol.MessageBody
{
    ...
    /// 定距拍照控制，见 表 15
    /// </summary>
    public class JT808_0x8103_0x0065 : JT808MessagePackFormatter<JT808_0x8103_0x0065>, JT808_0x8103_BodyBase, IJT808Analyze
    {
        /// <summary>
        /// 0x0065
        /// </summary>
        public uint ParamId { get; set; } = 0x0065;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// 定距拍照控制
        /// </summary>
        public string Description => "定距拍照控制";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0065 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0065 jT808_0x8103_0x0065 = new JT808_0x8103_0x0065();
            jT808_0x8103_0x0065.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0065.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0065 value, IJT808Config config)
        {
