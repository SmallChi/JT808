...
namespace JT808.Protocol.MessageBody
{
    ...
    /// </summary>
    public class JT808_0x8103_0x0022 : JT808MessagePackFormatter<JT808_0x8103_0x0022>, JT808_0x8103_BodyBase,  IJT808Analyze
    {
        /// <summary>
        /// 0x0022
        /// </summary>
        public  uint ParamId { get; set; } = 0x0022;
        /// <summary>
        /// 数据长度
        /// 4 byte
        /// </summary>
        ...
        /// 驾驶员未登录汇报时间间隔
        /// </summary>
        public  string Description => "驾驶员未登录汇报时间间隔";
        ...
        /// <param name="config"></param>
        /// <returns></returns>
        public override JT808_0x8103_0x0022 Deserialize(ref JT808MessagePackReader reader, IJT808Config config)
        {
            JT808_0x8103_0x0022 jT808_0x8103_0x0022 = new JT808_0x8103_0x0022();
            jT808_0x8103_0x0022.ParamId = reader.ReadUInt32();
            jT808_0x8103_0x0022.ParamLength = reader.ReadByte();
        ...
        /// <param name="config"></param>
        public override void Serialize(ref JT808MessagePackWriter writer, JT808_0x8103_0x0022 value, IJT808Config config)
        {
